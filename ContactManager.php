...
class ContactManager {
    ...
    public function __construct() {
        // Récupère l'instance de la connexion PDO à la base de données via le singleton DBConnect
    ...
    public function findAll(): array {
        ...
        try {
            // Exécute une requête SQL pour récupérer tous les contacts
            ...
            while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                ...
                // permet de donner à l'objet Contact l'ID récupéré depuis la base de données
