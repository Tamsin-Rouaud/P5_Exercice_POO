<?php
    // Utilisation d'un singleton pattern. Conditions à respecter pour ce pattern => une seule instance de la classe, l'accès à cet instance via une méthode statique et l'empêchement de la création d'instances multiples grâce à un constructeur privé.
    ...
    class DBConnect {
        ...
        // Constructeur privé pour empêcher l'instanciation directe de la classe (condition du pattern Singleton)
